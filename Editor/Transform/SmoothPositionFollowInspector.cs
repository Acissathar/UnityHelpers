...
namespace UnityHelpers.Editor.Transform
{
    ...
    public class SmoothPositionFollowInspector : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(smoothTypeProp, new GUIContent("Smooth Type",
            ...
            EditorGUILayout.PropertyField(extrapolatePositionProp,
                new GUIContent("Extrapolate Position",
                    "Should position values be extrapolated to compensate for delay caused by smoothing."));
